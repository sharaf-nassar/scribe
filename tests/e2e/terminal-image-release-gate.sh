...
CRITERIA=(
    ...
    "US4.5|Decoder selection may patch, vendor, or replace upstream to enforce caller-controlled limits|decode-spike-evidence.json sixel-decoder-evidence.json"
    "US4.6|Corpus-based malformed-input validation covers framing, chunking, decompression, dimensions, and deletion|framing.json decode-spike-evidence.json mutations.json"
