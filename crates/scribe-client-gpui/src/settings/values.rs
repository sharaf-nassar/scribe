...
fn appearance_value(config: &ScribeConfig, key: &str) -> Option<Value> {
    ...
    let v = match key {
        ...
        "appearance.content_padding_top" => json!(a.content_padding.top),
        "appearance.content_padding_right" => json!(a.content_padding.right),
        "appearance.content_padding_bottom" => json!(a.content_padding.bottom),
        "appearance.content_padding_left" => json!(a.content_padding.left),
