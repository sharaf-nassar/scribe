...
| Q4: enforce FR-008 for AI tabs; file plain-tab zsh/fish defect separately | Architecture Approach (Q4 paragraph); items 2a, 2b, 7a (spec-006 defect bead), 7b (server.md:572 correction) | full |
