...
Generated by `tools/perf-ab-rig/run-perf-ab.sh` (mode: `live`) at 2026-07-25T06:14:59Z.
...
| Metric | Threshold |
|---|---|
| Startup to first frame | no worse than old client end-to-end (10% noise allowance, median of 3) |
...
|---|---|---|---|
| Startup to first frame (end-to-end) | 1274.250 ms | 3697 ms | PASS |
...
Same-host A/B (Q3 re-scope 2026-07-24): PASS when the new client's median startup is within 10% of the old client's, both measured end-to-end (process start / first startup log to first painted frame or GPU-ready, median of 3). Splash deletion (OQ8) stays authorized while this PASSes. Old client: 3697 ms.
